...
trackers = tracker_list('siamKalman', 'TODO'); % TODO: add more trackers here

workspace_analyze(trackers, sequences, experiments, 'report_siamKalman', 'Title', 'Report for vot2015');
